        ...
        <div className="relative w-full h-screen flex items-center justify-center bg-gradient-to-br from-lime-50 via-lime-100 to-emerald-50 py-40 px-4">
            ...
            <div className="text-center mb-10 animate-fadeIn">
                ...
                <div className="relative z-10 w-full max-w-lg p-10 rounded-3xl shadow-2xl bg-white/90 backdrop-blur-md border border-white/60 animate-pulse-slow">
                    ...
                    <p className="text-gray-600 text-lg">Join us and feel the rhythm of life.</p>


                    <form onSubmit={handleSubmit} className="space-y-6">
                        {/* Name */}
                        <div className="relative group">
                            <User2 className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-700 group-focus-within:text-gray-800 transition-all duration-300 pointer-events-none" size={20} />
                            <input
                                type="text"
                                name="name"
                                placeholder="Name"
                                ...
                                required
                                className="w-full h-14 bg-white/70 backdrop-blur-sm border-2 border-gray-200 rounded-2xl py-4 pl-14 pr-4 text-lg text-gray-800 placeholder-gray-400 focus:border-lime-400 focus:ring-4 focus:ring-lime-100/60 focus:outline-none transition-all duration-500 shadow-lg hover:shadow-xl group-hover:border-lime-300 relative z-10"
                            />
                        </div>
                    ...
                    <p className="text-center text-sm mt-6 text-gray-700 pt-6 border-t border-gray-200">
                        ...
                        <Link to="/signin" className="font-bold text-lime-600 hover:text-lime-700 hover:underline transition-all duration-300">
                            Sign In
                        </Link>
                    </p>
                </div>
